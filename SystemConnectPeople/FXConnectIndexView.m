...
@end
@implementation FXConnectIndexView
...
- (void)setTableViewIndexDelegate:(id<TableViewIndexDelegate>)tableViewIndexDelegate
{
...
- (CATextLayer*)textLayerWithSize:(CGFloat)size string:(NSString*)string andFrame:(CGRect)frame{
    ...
    [tl setForegroundColor:[UIColor blueColor].CGColor];
    NSLog(@"CATextLayer === %@",string);
    [tl setString:string];
    return tl;
}
